...
# §2.1 de-cant. Scripted test-bed, VDASH_GRASP_OFF_DEG sweep, finger + grasp diag.
set -u
...
for d in 0 2 4 6 8 12 16 20; do
  out="$LD/fcal_d${d}.out"
  env VDASH_GRASP_OFF_MM=0 VDASH_GRASP_OFF_DEG="$d" VDASH_GRASP_DIAG=1 VDASH_FINGER_DIAG=1 \
