...
Run inside the container (IPAexGothic required):
  /isaac-sim/python.sh scripts/vdash/plot_rsj_paper_figs_ja.py
Outputs -> figs/vdash/{multiseed_v6,e4_basin,budget_response,clearance_cliff,budget_gate,grasp_compare}.png
"""
...
def fig_basin():
    ...
    for r in read_rows(os.path.join(REPO, "results/vdash/e4_basin_az12.csv")):
