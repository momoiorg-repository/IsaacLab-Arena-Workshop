...
VDASH_VLA_DEBUG=1 VDASH_TACTILE_CAL=1 VDASH_CAL_HALF_MM=8 VDASH_CAL_STEP_MM=4 VDASH_EPISODE_S=90 \
  ...
  --log_dir logs/vdash --no_resume --out "$RD/eval_v6_gentleprobe.csv" > "$out" 2>&1
