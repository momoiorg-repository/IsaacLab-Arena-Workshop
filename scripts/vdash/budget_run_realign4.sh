...
BASE="VDASH_GRASP_OFF_MM=6 VDASH_GRASP_OFF_DEG=6 VDASH_REALIGN=1 VDASH_GRIP_STIFF=200 VDASH_GRASP_DIAG=1"
...
run realign_only ""
run rccxy_002    "VDASH_INS_RCC_XY_GAIN=0.002"
run rccxy_005    "VDASH_INS_RCC_XY_GAIN=0.005"
run wide_spiral  "VDASH_INS_SPIRAL_RADIUS_MAX=0.013 VDASH_INS_SPIRAL_RADIUS_RATE=0.0001"
run rccxy_wide   "VDASH_INS_RCC_XY_GAIN=0.003 VDASH_INS_SPIRAL_RADIUS_MAX=0.013"
