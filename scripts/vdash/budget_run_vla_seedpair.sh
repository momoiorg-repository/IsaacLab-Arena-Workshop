...
# estimate. Appends one row per arm to results/vdash/repro/vla_pool.csv. Combo = re-align stiff200 + RCC-xy
...
run_arm combo    "VDASH_REALIGN=1 VDASH_GRIP_STIFF=200 VDASH_INS_RCC_XY_GAIN=0.005"
run_arm baseline ""
