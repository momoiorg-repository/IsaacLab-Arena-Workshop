...
#
# Run:
#   bash scripts/bdash/train_and_push_v6_recovery.sh
set -euo pipefail
...
DATASET_PATH="${DATASET_PATH:-datasets/bdash/vla_pick_handoff_v5_recovery/lerobot}"
OUTPUT_DIR="${OUTPUT_DIR:-models/bdash-gr00t-n1-7-pick-handoff-v6-recovery}"
