...
converter:
    ...
    /isaac-sim/python.sh scripts/bdash/merge_hdf5_demos.py \\
        --inputs datasets/bdash/_v5_parts/v5_{clean,wide,recovery}.hdf5 \\
        --output datasets/bdash/vla_pick_handoff_v5_recovery.hdf5
"""
