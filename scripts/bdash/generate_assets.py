...
# SPDX-License-Identifier: Apache-2.0
"""B-DASH parametric peg / socket asset generation (M1).
...
Example::
    ...
    docker exec isaaclab_arena-latest bash -lc '
      ...
      /isaac-sim/python.sh scripts/bdash/generate_assets.py --headless'
"""
...
parser = argparse.ArgumentParser(description="Generate B-DASH parametric peg/socket USDs.")
parser.add_argument("--config", type=str, default="configs/bdash/peg_insert/assets.yaml")
...
# --------------------------------------------------------------------------------------
# Defaults (mirror configs/bdash/peg_insert/assets.yaml; used if yaml/file unavailable)
# --------------------------------------------------------------------------------------
DEFAULTS = {
    ...
    "output_dir": "assets/bdash/peg_insert",
}
