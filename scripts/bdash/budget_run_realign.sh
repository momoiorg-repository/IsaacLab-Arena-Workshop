...
# topple condition) and soften the finger grip during insertion (BDASH_REALIGN + BDASH_GRIP_STIFF) so
...
D=8
run baseline   $D ""
run realign800 $D "BDASH_REALIGN=1 BDASH_GRIP_STIFF=800"
run realign400 $D "BDASH_REALIGN=1 BDASH_GRIP_STIFF=400"
run realign200 $D "BDASH_REALIGN=1 BDASH_GRIP_STIFF=200"
