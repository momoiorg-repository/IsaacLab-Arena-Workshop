...
BDASH_VLA_DEBUG=1 BDASH_TACTILE_CAL=1 BDASH_CAL_HALF_MM=12 BDASH_CAL_STEP_MM=4 BDASH_EPISODE_S=90 \
  ...
  --log_dir logs/bdash --no_resume --out "$RD/eval_v6_tactile_fine.csv" > "$out" 2>&1
ec=$?
