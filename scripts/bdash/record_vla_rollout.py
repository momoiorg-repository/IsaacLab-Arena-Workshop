...
# SPDX-License-Identifier: Apache-2.0
"""Record start-to-finish VLA inference rollouts of the B-DASH pick->insert as mp4.
...
(``vla_rollout_ep03_success.mp4``). Cameras require rendering:
    ...
    unset DISPLAY
    /isaac-sim/python.sh scripts/bdash/record_vla_rollout.py \\
        --policy_type isaaclab_arena.policy.bdash_vla_policy.BDashVLAPolicy \\
        --policy_config_yaml_path isaaclab_arena_gr00t/policy/config/bdash_pick_insert_gr00t_closedloop_v6_recovery_config.yaml \\
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="results/bdash/rollout_videos")
