...
"""Sim-free unit tests for the V-DASH §3.4 predicates.
...
each predicate fires only where expected. Run fast with:
    /isaac-sim/python.sh -m pytest isaaclab_arena_environments/tests/test_vdash_predicates.py
or standalone:
    /isaac-sim/python.sh isaaclab_arena_environments/tests/test_vdash_predicates.py
"""
...
_spec = importlib.util.spec_from_file_location(
    "vdash_predicates", os.path.join(os.path.dirname(__file__), "..", "mdp", "vdash_predicates.py")
)
