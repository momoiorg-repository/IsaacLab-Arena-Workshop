...
# SPDX-License-Identifier: Apache-2.0
"""B-DASH scene-diversity randomization profiles L0–L3 (brief §3.6 / scene-diversity sweep).
...
into :class:`~isaaclab_arena.tasks.bdash_pick_insert_task.BDashPickInsertTask` and adds the distractor
assets to the scene. Ranges are overridable from ``configs/bdash/peg_insert`` but carry sane defaults here.
"""
